 ...
 * @return String
 */
function path( ? String $app = Null, ? String $base = Null, ? String $util = Null, ? String $config = Null, ? String $routes = Null, ? String $storage = Null, ? String $resource = Null, ? String $noteware = Null ): String
{
    $path = BASE_PATH;
