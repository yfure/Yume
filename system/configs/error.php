...
return([
	"handler" => [
		 ...
		 */
		"trigger" => env( "E_TRIGGER_HANDLER", "Yume\\Fure\\Error\\Erahandora\\Erahandora::trigger" ),
		 ...
		 */
		"exception" => env( "E_EXCEPT_HANDLER", "Yume\\Fure\\Error\\Erahandora\\Erahandora::exception" ),
	],
